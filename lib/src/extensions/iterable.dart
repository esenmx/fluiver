...
extension IterableSeparator<E> on Iterable<E> {
  ...
  /// but you can use it anywhere; [Flex], [Scrollable], [InlineSpan]...
  /// ```dart
  /// [Child(), Child()].separated((_) => Divider()) // [Child(), Divider(), Child()]
  /// ```
  /// [index] refers to the separator index, not element index.
