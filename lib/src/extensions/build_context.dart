...
extension BuildContextMediaQuery on BuildContext {
  ...
  bool get isPlatformDark => MediaQuery.platformBrightnessOf(this) == .dark;
  bool get isPlatformLight => MediaQuery.platformBrightnessOf(this) == .light;

  bool get isOrientationPortrait => MediaQuery.orientationOf(this) == .portrait;
  bool get isOrientationLandscape =>
      MediaQuery.orientationOf(this) == .landscape;
...
extension BuildContextThemeBrightness on BuildContext {
  bool get isThemeDark => _t.brightness == .dark;
  bool get isThemeLight => _t.brightness == .light;
}

/// {@macro extensionFor}
/// Checking text direction.
extension BuildContextDirectionality on BuildContext {
  bool get isDirectionalityLtr => Directionality.of(this) == .ltr;
  bool get isDirectionalityRtl => Directionality.of(this) == .rtl;
}
